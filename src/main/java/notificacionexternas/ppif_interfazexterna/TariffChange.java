...
/**
 * Define the ASN1 Type TariffChange from ASN1 Module PPIF_INTERFAZEXTERNA.
 * @see Sequence
 */

public class TariffChange extends Sequence {
     ...
     */
    public TariffChange(PrintableString oldTariff)
    {
	setOldTariff(oldTariff);
    }
    ...
    // Methods for field "oldTariff"
    public PrintableString getOldTariff()
    {
	return (PrintableString)mComponents[0];
    }

    public void setOldTariff(PrintableString oldTariff)
    {
	mComponents[0] = oldTariff;
    }
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' TariffChange object.
     */
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' TariffChange object.
     */
...
} // End class definition for TariffChange
