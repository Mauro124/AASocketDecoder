...
/**
 * Define the ASN1 Type BajaPeriodificacion from ASN1 Module PPIF_INTERFAZEXTERNA.
 * @see Sequence
 */

public class BajaPeriodificacion extends Sequence {

    /**
     * The default constructor.
     */
    public BajaPeriodificacion()
    {
    }
     ...
     */
    public BajaPeriodificacion(PrintableString codTipoActPerio,
		    PrintableString longBOCode, PrintableString secuencia)
    {
    ...
    {
	mComponents[2] = secuencia;
    }

    public boolean hasSecuencia()
    {
	return componentIsPresent(2);
    }

    public void deleteSecuencia()
    {
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' BajaPeriodificacion object.
     */
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' BajaPeriodificacion object.
     */
...
} // End class definition for BajaPeriodificacion
