...
/**
 * Define the ASN1 Type WalletThresholdEvent from ASN1 Module PPIF_INTERFAZEXTERNA.
 * @see Sequence
 */

public class WalletThresholdEvent extends Sequence {

    /**
     * The default constructor.
     */
    public WalletThresholdEvent()
    {
    }
     ...
     */
    public WalletThresholdEvent(INTEGER walletID, INTEGER64 threshold)
    {
     ...
     */
    public WalletThresholdEvent(long walletID, INTEGER64 threshold)
    {
	this(new INTEGER(walletID), threshold);
    }
    ...
    public INTEGER64 getThreshold()
    {
	return (INTEGER64)mComponents[1];
    }

    public void setThreshold(INTEGER64 threshold)
    {
	mComponents[1] = threshold;
    }
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' WalletThresholdEvent object.
     */
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' WalletThresholdEvent object.
     */
...
} // End class definition for WalletThresholdEvent
